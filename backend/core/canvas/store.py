...
def _history_entry_size_ok(item: dict[str, Any]) -> bool:  # noqa: allow-dict-any
...
def _meta_from_dict(raw: dict[str, Any]) -> tuple[str, str, str]:  # noqa: allow-dict-any
    return (
...
class CanvasStore:
    ...
    @staticmethod
    def _history_entries(value: object) -> list[dict[str, Any]]:  # noqa: allow-dict-any
    ...
    def get(self, doc_id: str) -> dict[str, Any] | None:  # noqa: allow-dict-any
        with self._lock:
    ...
    def _normalize_history_item(self, item: dict[str, Any]) -> dict[str, Any]:  # noqa: allow-dict-any
        if isinstance(item, dict) and item.get("type") == "diff":
            return item
        return normalize_document(item)

    def get_history(self, doc_id: str) -> dict[str, list[dict[str, Any]]]:  # noqa: allow-dict-any
        with self._lock:
    ...
    def save_history(
        self,
        doc_id: str,
        past: list[dict[str, Any]],  # noqa: allow-dict-any
        future: list[dict[str, Any]],  # noqa: allow-dict-any
        max_history: int = 30,
    ) -> bool:
        with self._lock:
            path = self._history_path_for(str(doc_id))
            self.history_dir.mkdir(parents=True, exist_ok=True)
            norm_past: list[dict[str, Any]] = []  # noqa: allow-dict-any
            ...
            norm_future: list[dict[str, Any]] = []  # noqa: allow-dict-any
    ...
    def save(self, document: dict[str, Any], *, touch: bool = True) -> dict[str, Any]:  # noqa: allow-dict-any
        with self._lock:
    ...
    def create(self, *, name: str = "Sin título") -> dict[str, Any]:  # noqa: allow-dict-any
    ...
    def _refresh_index_entry(self, doc: dict[str, Any], path: Path) -> None:  # noqa: allow-dict-any
    ...
    def duplicate(self, doc_id: str, *, name: str | None = None) -> dict[str, Any]:  # noqa: allow-dict-any
