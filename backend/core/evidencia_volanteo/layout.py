...
PAGE_WIDTH_CM = 21.0
PAGE_HEIGHT_CM = 29.7
TABLE_WIDTH_CM = round(PAGE_WIDTH_CM - 2 * PAGE_MARGIN_CM, 2)
CONTENT_HEIGHT_CM = round(PAGE_HEIGHT_CM - 2 * PAGE_MARGIN_CM, 2)

HEADER_TITLE_HEIGHT_CM = 1.5
HEADER_INFO_HEIGHT_CM = 1.3
HEADER_TOTAL_HEIGHT_CM = round(HEADER_TITLE_HEIGHT_CM + HEADER_INFO_HEIGHT_CM, 2)
GAP_UNDER_HEADER_CM = 0.4
PHOTO_GAP_CM = 0.1
PHOTO_COLS = 3
PHOTO_ROWS = 2
PHOTO_GAP_COLS = PHOTO_COLS + 1
PHOTO_TABLE_COLS = PHOTO_COLS + PHOTO_GAP_COLS
PHOTO_GAP_ROWS = PHOTO_ROWS + 1
PHOTO_TABLE_ROWS = PHOTO_ROWS + PHOTO_GAP_ROWS
GAP_HEIGHT_CM = PHOTO_GAP_CM

HEADER_LOGO_WIDTH_CM = 4.2
HEADER_TITLE_WIDTH_CM = round(TABLE_WIDTH_CM - 2 * HEADER_LOGO_WIDTH_CM, 2)
