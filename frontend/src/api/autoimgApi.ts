import type {
  AutoImgArrastreResponse,
  AutoImgBootstrapResponse,
  AutoImgFolder,
  AutoImgFolderPreviewResponse,
  AutoImgFoldersResponse,
  AutoImgStatus,
  AutoImgSyncFromSheetResponse,
  DriveVerifyResult,
} from '../components/autoimg/types';
...
export function createAutoimgApi(invoke: IpcInvoke) {
  return {
    ...
    autoimgDriveVerifyFolder: (urlOrId: string) =>
      invoke<DriveVerifyResult>('autoimg_drive_verify_folder', { url: urlOrId }),
    autoimgDriveFolderPreview: (folder_id: string, force = false) =>
      invoke<AutoImgFolderPreviewResponse>('autoimg_drive_folder_preview', { folder_id, force }),
    autoimgDriveStatus: () => invoke<{ connected: boolean }>('autoimg_drive_status'),
    autoimgFoldersList: (force = false) =>
      invoke<AutoImgFoldersResponse>('autoimg_folders_list', { force }),
    ...
    autoimgArrastreList: (force = false) =>
      invoke<AutoImgArrastreResponse>('autoimg_arrastre_list', { force }),
