...
const EMPTY_REPORT: TechnicalReport = {
  ...
  inspeccion: {
    ...
    observaciones_caja_registro: '', sugerencias_caja_registro: '',
    observaciones_marco_tapa: '', sugerencias_marco_tapa: '',
    observaciones_escalera_int: '', sugerencias_escalera_int: '',
    observaciones_escalera_ext: '', sugerencias_escalera_ext: '',
    observaciones_cuba_int: '', sugerencias_cuba_int: '',
    observaciones_cuba_ext: '', sugerencias_cuba_ext: '',
    observaciones_loza_fondo: '', sugerencias_loza_fondo: '',
    observaciones_loza_techo_int: '', sugerencias_loza_techo_int: '',
    observaciones_loza_techo_ext: '', sugerencias_loza_techo_ext: '',
    observaciones_ducto: '', sugerencias_ducto: '',
    observaciones_cerco: '', sugerencias_cerco: '',
    observaciones_descarga: '', sugerencias_descarga: '',
  },
  valvulas: {
      ...
      <div className="tr-paper">
        ...
        <table className="tr-paper-table">
          <tbody>
            ...
            <tr><th>Contratista :</th><td>{data.header.contratista}</td><th>{data.header.sgio_label || DEFAULT_SGIO_LABEL} :</th><td>{data.header.sgio}</td></tr>
